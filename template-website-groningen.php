...
<div class="relative z-10 bg-white/[0.98] pt-5 pr-10 pb-10 pl-10 md:p-8 rounded-lg max-w-2xl fade-in-up w-full md:w-auto">
  ...
  <h2 class="text-[50px] md:text-[5rem] font-bold text-primary-container mb-6 italic leading-[0.77] md:leading-normal">Niet duur. Wel goed.</h2>
    ...
    <div class="w-full kaartje-45">
      <div class="p-8 bg-surface-container-low border border-black/5 rounded-lg shadow-sm" style="transform: rotate(2deg)">
        <div class="flex gap-4 items-start mt-2">
          ...
          <p class="text-lg leading-relaxed">We spreken af wat je nodig hebt. Niet meer, niet minder.</p>
        </div>
        ...
        <div class="flex gap-4 items-start mt-4">
          ...
          <p class="text-lg leading-relaxed">We houden het bij. Als iets moet, dan komt dat goud.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch md:gap-0">
    <div class="bg-surface-container-low p-6 md:p-12 flex flex-col justify-center md:rounded-l rounded relative overflow-hidden order-1 md:order-2">
      ...
      <div class="space-y-4 relative z-10">
        ...
        <p class="text-xl font-bold text-primary-container">Geen geneuzel. We doen wat werkt.</p>
      </div>
    </div>
  ...
  <div class="max-w-2xl">
    ...
    <div>
      <details style="border-bottom:1px solid #e5e7eb;padding-bottom:20px;margin-bottom:20px">
        ...
        <p class="text-lg leading-relaxed opacity-80" style="padding-top:14px">Een website laten maken kost afhankelijk van je wensen tussen de 1.000 en 5.000 euro. Een eenvoudige presentatiesite voor een zzp'er zit aan de onderkant. Een uitgebreide website met webshop en maatwerk functionaliteiten aan de bovenkant. Wij werken met WordPress, zodat jij na oplevering zelf content kunt toevoegen zonder technische kennis. We starten altijd met een gesprek over wat je echt nodig hebt, zodat je niet betaalt voor features die je nooit gebruikt.</p>
      </details>
      <details style="border-bottom:1px solid #e5e7eb;padding-bottom:20px;margin-bottom:20px">
